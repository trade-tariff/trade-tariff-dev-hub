...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_dev-hub-job"></a> [dev-hub-job](#module\_dev-hub-job) | git@github.com:trade-tariff/trade-tariff-platform-terraform-modules.git//aws/ecs-service | aws/ecs-service-v1.19.2 |
