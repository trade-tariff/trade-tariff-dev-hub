...
class Notification
  ...
  ROLE_REQUEST_TEMPLATE_ID = ENV.fetch("ROLE_REQUEST_TEMPLATE_ID", "role-request-template-id").freeze
  ROLE_REQUEST_APPROVED_TEMPLATE_ID = ENV.fetch("ROLE_REQUEST_APPROVED_TEMPLATE_ID", "role-request-approved-template-id").freeze
