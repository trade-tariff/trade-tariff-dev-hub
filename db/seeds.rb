...
if Rails.env.development?
  ...
  # Create 1 OTT key for Admin Dev Org
  Ott::CreateOttKey.new.call(admin_dev_org.id, "Admin Dev Org OTT Key")
  ...
  # Assign only ott:full and fpo:full roles (not admin)
  dev_user_org.assign_role!("ott:full")
