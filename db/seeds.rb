...
if Rails.env.development?
  ...
  User.find_or_create_by!(email_address: "alice.white@acmelogistics.example.com") do |u|
  ...
  User.find_or_create_by!(email_address: "dave.brown@globalexpress.example.com") do |u|
  ...
  User.find_or_create_by!(email_address: "grace.martin@techfreight.example.com") do |u|
